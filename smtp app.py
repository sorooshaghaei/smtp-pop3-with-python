...
#Buttons
Button(master, text = "Send", command = send).grid(row=7, column=2,  sticky=W,  pady=15, padx=5)
Button(master, text = "Reset", command = reset).grid(row=7,  sticky=W, padx=70)
Button(master, text = "Quit", command = master.quit).grid(row=7,  sticky=W, padx=5)
